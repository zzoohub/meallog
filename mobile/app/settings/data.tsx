...
export default function DataManagementSettings() {
  ...
  const handleExportData = async () => {
    try {
      Alert.alert("Export Data", "This will create a file containing all your meal log data, photos, and settings.", [
  ...
  const handleImportData = () => {
    Alert.alert(
      "Import Data",
      "This feature would allow you to import data from other meal tracking apps or a previous export.",
      [{ text: "OK" }],
    );
  };
    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          style: "destructive",
          onPress: () => {
            Alert.alert("Final Warning", "Are you absolutely sure? This will delete everything and cannot be undone.", [
              { text: "Cancel", style: "cancel" },
              {
                text: "Yes, Delete All",
                style: "destructive",
  ...
  return (
    <SettingsLayout title="Data Management">
      <SettingsSection title="Storage Usage" footer={`Total storage used: ${getTotalStorage()} MB`}>
        <SettingsItem
          title="Photos"
          description="Meal photos and images"
          icon="image-outline"
          type="info"
        ...
        <SettingsItem
          title="Meal Data"
          description="Meal logs and nutrition data"
      ...
      <SettingsSection title="Data Export & Import" footer="Export your data for backup or transfer to another device">
        <SettingsItem
      ...
      <SettingsSection title="Data Cleanup" footer="Free up storage space by removing temporary files">
        <SettingsItem
          title="Clear Cache"
      ...
      <SettingsSection title="Danger Zone" footer="These actions cannot be undone">
        <SettingsItem
      ...
      <SettingsSection title="Data Policy" footer="Learn about how your data is handled">
        <SettingsItem
